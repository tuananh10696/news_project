        ...
        <div class="col-md-9" data-aos="fade-up">
          ...
          <?php foreach ($infos as $news_index_data) : ?>
            <div class="d-md-flex post-entry-2 half">
              <a href="/categories/<?= $news_index_data->id ?>" class="me-4 thumbnail">
                <img src="<?= $news_index_data->attaches['image'][0] ?>" alt="" class="img-fluid">
              </a>
              <div>
                <div class="post-meta"><span><?= $news_index_data->start_datetime->format('Y.m.d') ?></span></div>
                <h3><a href="/categories/<?= $news_index_data->id ?>"><?= $news_index_data->title ?></a></h3>
