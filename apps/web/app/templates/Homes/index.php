					...
					<?php foreach ($doi_song as $id => $doi_song_data) : ?>
						<?php if ($id == 0) : ?>
							<div class="post-entry-1 lg border-bottom">
								<a href="/news/<?= $doi_song_data['id'] ?>"><img src="<?= $doi_song_data['attaches']['image'][0] ?>" alt="" class="img-fluid"></a>
								...
								<div class="d-flex align-items-center author">
									<!-- <div class="photo"><img src="assets/img/anh.jpeg" alt="" class="img-fluid"></div> -->
									<a href="">
										<div class="name">
					...
					<div class="row g-5">
						...
						<div class="col-lg-4 border-start custom-border">
							<?php foreach ($giai_tri as $id => $giai_tri_data) : ?>
								<div class="post-entry-1">
									<a href="/news/<?= $giai_tri_data['id'] ?>"><img src="<?= $giai_tri_data['attaches']['image'][0] ?>" alt="" class="img-fluid"></a>
						...
						<div class="col-lg-4 border-start custom-border">
							<?php foreach ($hoc_tap as $id => $hoc_tap_lam_viec_data) : ?>
								<div class="post-entry-1">
									<a href="/news/<?= $hoc_tap_lam_viec_data['id'] ?>"><img src="<?= $hoc_tap_lam_viec_data['attaches']['image'][0] ?>" alt="" class="img-fluid"></a>
						...
						<div class="col-lg-4 border-start custom-border">
							...
							<ul class="nav nav-pills custom-tab-nav mb-4" id="pills-tab" role="tablist">
								<li class="nav-item-top" role="presentation">
									<button class="nav-link" id="pills-popular-tab" data-bs-toggle="pill" data-bs-target="#pills-popular" type="button" role="tab" aria-controls="pills-popular" aria-selected="true">All</button>
								</li>
								<li class="nav-item-top" role="presentation">
									<button class="nav-link active" id="pills-trending-tab" data-bs-toggle="pill" data-bs-target="#pills-trending" type="button" role="tab" aria-controls="pills-trending" aria-selected="false">Trending</button>
								</li>
								<li class="nav-item-top" role="presentation">
