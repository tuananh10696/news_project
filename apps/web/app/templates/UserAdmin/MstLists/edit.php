...
<?= $this->Form->input('sys_cd', ['type' => 'hidden']); ?>
...
<div class="table_edit_area">
	...
	<?php if (!empty($query['slug'])) : ?>
		...
		<?php else : ?>
			<?= $this->Form->input('name', [
				'type' => 'text', 'value' => $data['name'], 'readonly' => true,
	...
	<?= $this->Form->input('ltrl_val', ['type' => 'text', 'maxlength' => 40, 'class' => 'form-control']); ?>
	<?= $this->element('edit_form/item-end'); ?>

	<?= $this->element('edit_form/item-start', ['title' => '予備キー']); ?>
	<?= $this->Form->input('ltrl_sub_val', ['type' => 'text', 'maxlength' => 100, 'class' => 'form-control']); ?>
	<?= $this->element('edit_form/item-end'); ?>
