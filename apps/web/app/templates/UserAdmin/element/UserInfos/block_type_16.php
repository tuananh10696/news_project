<div class="table__row first-dir item_block" id="block_no_<?= h($rownum); ?>" data-sub-block-move="1">
									...
									<div class="row mb-1">
										<div class="col-3">
											<div class="input-group">
												...
												<input class="form-control _color" type="color" value="<?= $content['option_value2'] ? $content['option_value2'] : '#f1f349' ?>">
												<?= $this->Form->input("info_contents.{$rownum}.option_value2", ['type' => 'text', 'class' => '_color form-control']); ?>
											</div>
										</div>
										<div class="col-4">
											<div class="input-group">
												<div class="input-group-prepend">
													<span class="input-group-text">Avatar向き</span>
												</div>
												<?= $this->Form->select("info_contents.{$rownum}.option_value3", ['left' => '左', 'right' => '右'], ['class' => 'form-control']); ?>
											</div>
										</div>
									</div>

									<?= $this->Form->input("info_contents.{$rownum}.content", ['type' => 'textarea', 'placeholder' => '※会話内容', 'class' => 'form-control', 'maxlength' => 500]); ?>
	...
	<div class="table__column table__column-sub">
		<span style="font-size:0.9rem;"><?= (h($rownum) + 1); ?>.会話</span>
