...
$value = $is_main ? $entity->date : @$entity->info_append_items[$num]->{$content->slug};
?>
    ...
    <div class="col-12 col-md-9 control_value">
        ...
        <div class="input-group">
            <div class="input-group-prepend d-block">
                <?= $this->Form->input($item_key, ['type' => 'text', 'value' => ($value ?? new DateTime('now'))->format('Y/m/d'), 'class' => '_datepicker form-control', 'readonly' => 'readonly', 'style' => 'width:100px;']) ?>
            </div>
        </div>
    </div>
</div>