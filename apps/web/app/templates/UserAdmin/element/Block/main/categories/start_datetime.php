    ...
    <div class="col-12 col-md-9 control_value">
        ...
        <div class="input-group">
            <div class="input-group-prepend d-block">
                <?= $this->Form->input($item_key, ['type' => 'text', 'value' => (new DateTime($entity->datetime ? $entity->datetime : 'now'))->format('Y/m/d H:i'), 'class' => 'datetimepicker form-control', 'readonly' => 'readonly', 'style' => 'width:150px;']) ?>
            </div>
        </div>
    </div>
</div>