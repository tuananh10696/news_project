			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body table_area">
						<dl>
							<dt style="margin-top: 10px;">Image Alt</dt>
							<dd>
								<?= $this->Form->input("info_contents.{$rownum}.img_alt", ['type' => 'text', 'class' => 'form-control', 'maxlength' => '200']); ?>
							</dd>

							<dt style="margin-top: 10px;">Image Content</dt>
							<dd>
								<?= $this->Form->input("info_contents.{$rownum}.content", ['type' => 'text', 'class' => 'form-control', 'maxlength' => '200']); ?>
							</dd>

							<dt style="margin-top: 10px;">Url
							...
							<dd>
								<?= $this->Form->input("info_contents.{$rownum}.option_value2", ['type' => 'text', 'class' => 'form-control', 'maxlength' => '255', 'placeholder' => 'http://']); ?>
							</dd>
						</dl>
					</div>
