						...
						<div class="card-body" style="border: 1px solid #cbcbcb;">
							<div class="row">
								...
								<div class="text-center td_parent">
									...
									<?= $this->Form->input("info_contents.{$rownum}.image2", ['type' => 'file', 'id' => "__image2{$rownum}", 'class' => 'attaches dpl_none', 'accept' => '.jpeg, .jpg, .png, .gif', 'onChange' => 'chooseFileUpload(this)', 'data-type' => 'image/jpeg,image/gif,image/png']); ?>

									<div class="preview_img t_align_c dpl_none w-100 avatar" style="margin-left: 20px;"></div>

									<?php if (!empty($content['attaches']['image2']['0'])) : ?>
										<div class="thumbImg <?= $rownum ?>">
											<img class="mw-100 profile-user-img img-fluid img-circle" src="<?= $this->Url->build($content['attaches']['image2']['0']) ?>" style="margin-left: 20px;width: 120px; height: 120px;object-fit: cover;">
											<?= $this->Form->hidden("info_contents.{$rownum}._old_image2", ['value' => h($content['image2']), 'class ' => 'old_img_input']); ?>
										</div>
									<?php endif; ?>

									<div class="img_text t_align_c">
										<label type="button" class="btn btn-light edit__image-button" for="__image2<?= $rownum ?>">
											<i class="fas fa-plus"></i>
											<i class="far fa-image"></i>
										</label>
									</div>
								...
								<div class="col-9" style="margin-left: 125px;">
									<div class="row mb-1">
										<div class="col-5">
