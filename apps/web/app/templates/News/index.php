<main id="main">
	...
	<section id="search-result" class="search-result">
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					<ul style="border-bottom: var(--bs-border-width) var(--bs-border-style) var(--bs-border-color) !important;" class="nav nav-pills custom-tab-nav mb-4" id="pills-tab" role="tablist">
						<!-- Categories -->
						<li class="nav-item" role="presentation">
							<a href="/news" class="">
								<button class="nav-link cate <?= $category_id == 0 ? 'categoryClass' : '' ?>" type="button" role="tab">All</button>
							</a>
						</li>
						<?php foreach ($category as $category_data) : ?>
							<li class="nav-item cate" role="presentation">
								<a href="/news?category_id=<?= $category_data->id ?>">
									<button class="nav-link cate <?= $category_data->id == $category_id ? 'categoryClass' : '' ?>" type="button" role="tab"><?= $category_data->name ?></button>
								</a>
							</li>
						<?php endforeach; ?>
					</ul>
					...
					<?php foreach ($infos as $news_index_data) : ?>
						<div class="d-md-flex post-entry-2 small-img">
							...
							<div>
								...
								<h3><a href="/news/<?= $news_index_data->id ?>"><?= h($news_index_data->title) ?></a></h3>
					...
					<div class="aside-block">
						...
						<div class="video-post">
							<a href="https://www.youtube.com/watch?v=AiFfDjmd0jU" class="glightbox link-video">
								...
								<img src="assets/img/post-landscape-5.jpg" alt="" class="img-fluid img">
							</a>
						</div>
					</div><!-- End Video -->
					<div class="aside-block">
